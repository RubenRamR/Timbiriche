...
public class FrmJuego extends javax.swing.JFrame {
    ...
    public FrmJuego() {
        ...
        // Simulamos conexión de red para iniciar el juego
    ...
    private void configurarInterfaz() {
        // Panel de información del juego (encima de todo)
        JPanel panelInfo = new JPanel();
        panelInfo.setBackground(new Color(255, 255, 255, 200)); // Semi-transparente
        ...
        // Creamos el panel del juego (se centrará sobre la imagen)
        panelJuego = new JPanel();
        panelJuego.setBackground(new Color(255, 255, 255, 180)); // Semi-transparente
        panelJuego.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20));

        // Panel contenedor para centrar el juego
        ...
        // Botón para simular desconexión o terminar partida
